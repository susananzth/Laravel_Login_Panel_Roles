...
<div class="max-w-7xl py-6 mx-auto sm:px-4 lg:px-6 space-y-6">
    <div class="p-4 sm:p-8 bg-white dark:bg-secondary-800 shadow sm:rounded-lg">
        ...
        @if($deleteDetailModal)
            <x-modal wire:model="deleteDetailModal" focusable
                ...
                <div class="mt-6 flex justify-end gap-4">
                    <x-button.secondary wire:click.prevent="cancelDetail()">
                        <i class="fa-solid fa-ban me-1"></i>{{ __('Cancel') }}
                    </x-button.secondary>
                    <x-button.danger type="button" wire:click.prevent="deleteDetail()">
