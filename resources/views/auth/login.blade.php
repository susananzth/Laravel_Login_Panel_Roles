    ...
    <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-secondary-800 shadow-md overflow-hidden sm:rounded-lg">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mt-4">
                ...
                <x-input.text id="password" class="block mt-1 w-full" type="password" 
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <a class="underline text-sm text-txtdark-600 dark:text-txtdark-400 hover:text-txtdark-900 
                    dark:hover:text-txtdark-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 
                    focus:ring-primary-500 dark:focus:ring-offset-secondary-800" 
