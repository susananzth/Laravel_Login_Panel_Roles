           ...
           'language': {
            ...
            'columns'       : [
              ...
              "render": function (data, type, row) {
                ...
                '<a href="/permisos/'+data+'"      class="btn btn-default btn-xs"><i class="glyphicon glyphicon-eye-open"></i></a>'+
                '<a href="/permisos/'+data+'/edit" class="btn btn-default btn-xs"><i class="glyphicon glyphicon-edit"></i></a>'+
                '</div>';
              }},
              {data:"permiso",
              "render": function (data, type, row) {
